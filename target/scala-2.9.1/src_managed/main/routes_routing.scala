...
// @LINE:15
val controllers_Start_estimator6 = Route("POST", PathPattern(List(StaticPart("/start"))))
                    

// @LINE:18
val securesocial_controllers_LoginPage_login7 = Route("GET", PathPattern(List(StaticPart("/login"))))
                    

// @LINE:19
val securesocial_controllers_LoginPage_logout8 = Route("GET", PathPattern(List(StaticPart("/logout"))))
                    

// @LINE:22
val securesocial_controllers_Registration_startSignUp9 = Route("GET", PathPattern(List(StaticPart("/signup"))))
                    

// @LINE:23
val securesocial_controllers_Registration_handleStartSignUp10 = Route("POST", PathPattern(List(StaticPart("/signup"))))
                    

// @LINE:24
val securesocial_controllers_Registration_signUp11 = Route("GET", PathPattern(List(StaticPart("/signup/"),DynamicPart("token", """[^/]+"""))))
                    

// @LINE:25
val securesocial_controllers_Registration_handleSignUp12 = Route("POST", PathPattern(List(StaticPart("/signup/"),DynamicPart("token", """[^/]+"""))))
                    

// @LINE:26
val securesocial_controllers_Registration_startResetPassword13 = Route("GET", PathPattern(List(StaticPart("/reset"))))
                    

// @LINE:27
val securesocial_controllers_Registration_handleStartResetPassword14 = Route("POST", PathPattern(List(StaticPart("/reset"))))
                    

// @LINE:28
val securesocial_controllers_Registration_resetPassword15 = Route("GET", PathPattern(List(StaticPart("/reset/"),DynamicPart("token", """[^/]+"""))))
                    

// @LINE:29
val securesocial_controllers_Registration_handleResetPassword16 = Route("POST", PathPattern(List(StaticPart("/reset/"),DynamicPart("token", """[^/]+"""))))
                    

// @LINE:30
val securesocial_controllers_PasswordChange_page17 = Route("GET", PathPattern(List(StaticPart("/password"))))
                    

// @LINE:31
val securesocial_controllers_PasswordChange_handlePasswordChange18 = Route("POST", PathPattern(List(StaticPart("/password"))))
                    

// @LINE:34
val securesocial_controllers_ProviderController_authenticate19 = Route("GET", PathPattern(List(StaticPart("/authenticate/"),DynamicPart("provider", """[^/]+"""))))
                    

// @LINE:35
val securesocial_controllers_ProviderController_authenticateByPost20 = Route("POST", PathPattern(List(StaticPart("/authenticate/"),DynamicPart("provider", """[^/]+"""))))
                    

// @LINE:38
val controllers_Assets_at21 = Route("GET", PathPattern(List(StaticPart("/assets/"),DynamicPart("file", """.+"""))))
                    
def documentation = List(("""GET""","""/""","""controllers.Application.index()"""),("""GET""","""/home""","""controllers.Application.home()"""),("""GET""","""/gallery""","""controllers.Application.gallery()"""),("""GET""","""/contact""","""controllers.Application.contact()"""),("""GET""","""/map""","""controllers.Application.map()"""),("""GET""","""/start""","""controllers.Start.estimator()"""),("""POST""","""/start""","""controllers.Start.estimator()"""),("""GET""","""/login""","""securesocial.controllers.LoginPage.login"""),("""GET""","""/logout""","""securesocial.controllers.LoginPage.logout"""),("""GET""","""/signup""","""securesocial.controllers.Registration.startSignUp"""),("""POST""","""/signup""","""securesocial.controllers.Registration.handleStartSignUp"""),("""GET""","""/signup/$token<[^/]+>""","""securesocial.controllers.Registration.signUp(token:String)"""),("""POST""","""/signup/$token<[^/]+>""","""securesocial.controllers.Registration.handleSignUp(token:String)"""),("""GET""","""/reset""","""securesocial.controllers.Registration.startResetPassword"""),("""POST""","""/reset""","""securesocial.controllers.Registration.handleStartResetPassword"""),("""GET""","""/reset/$token<[^/]+>""","""securesocial.controllers.Registration.resetPassword(token:String)"""),("""POST""","""/reset/$token<[^/]+>""","""securesocial.controllers.Registration.handleResetPassword(token:String)"""),("""GET""","""/password""","""securesocial.controllers.PasswordChange.page"""),("""POST""","""/password""","""securesocial.controllers.PasswordChange.handlePasswordChange"""),("""GET""","""/authenticate/$provider<[^/]+>""","""securesocial.controllers.ProviderController.authenticate(provider:String)"""),("""POST""","""/authenticate/$provider<[^/]+>""","""securesocial.controllers.ProviderController.authenticateByPost(provider:String)"""),("""GET""","""/assets/$file<.+>""","""controllers.Assets.at(path:String = "/public", file:String)"""))
...
// @LINE:15
case controllers_Start_estimator6(params) => {
   call { 
        invokeHandler(_root_.controllers.Start.estimator(), HandlerDef(this, "controllers.Start", "estimator", Nil))
   }
}
